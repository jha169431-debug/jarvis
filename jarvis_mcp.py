...
TOOL_SPECS = [
    ...
    },
    {
        ...
        "description": (
            ...
            "user means rather than paraphrasing. Only works when that terminal "
            "session exposes a backend JARVIS can address safely; on Linux this "
            "means an exactly identified tmux pane, while unsupported terminal "
            "hosts are refused. The target window MAY come to the front on some "
            "platforms, so only use it when the user has just asked for it. "
